...
class TestCoreConfigValidateSettings:
    def test_raises_when_gcp_project_id_empty(self) -> None:
        from core.core_config import CoreSettings, core_config_validate_settings
...
class TestCoreConfigGetSettings:
    def test_returns_core_settings_instance(self) -> None:
        from core.core_config import CoreSettings, core_config_get_settings
    ...
    def test_returns_same_instance_on_repeated_calls(self) -> None:
        from core.core_config import core_config_get_settings
